...
route.get('/get',auth.authenticateToken,(req,res,next)=>{
    var query = "select p.id,p.name,p.description,p.price,p.status,c.id as categoryId, c.name categoryName from product as p INNER JOIN category as c where p.categoryId = c.id";
